locals {
  ...
  container_def_json = {
    ...
    rocket = {
      container_def_json = templatefile("${path.module}/container_def.json.tpl", {
        image                 = "599564732950.dkr.ecr.us-east-2.amazonaws.com/starknet-remix-plugin:rocket-1",
    ...
    devnet = {
      container_def_json = templatefile("${path.module}/container_def.json.tpl", {
        image                 = "599564732950.dkr.ecr.us-east-2.amazonaws.com/starknet-remix-plugin:devnet-2",
